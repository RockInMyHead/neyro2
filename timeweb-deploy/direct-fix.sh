...
# Прямое исправление nginx конфигурации
echo "🔧 Прямое исправление nginx конфигурации..."
echo "📍 Текущая директория: $(pwd)"

# Создадим правильную конфигурацию
cat > nginx-corrected.conf << 'EOF'
server {
    listen 80;
...
echo "✅ Создана исправленная конфигурация"

# Создадим резервную копию и применим исправления
...
sudo cp nginx-corrected.conf /etc/nginx/sites-enabled/neyro
...
echo "✅ Прямое исправление завершено!"
